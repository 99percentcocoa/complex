...
The program uses three Google Sheets Spreadsheets:
	a. Test Corpus Sheet - this sheet contains the sentence IDs and sentences required to be processed.
	b. Connective Classes Sheet - this sheet contains the list of connectives, and what class/type they belong to.
	c. Output Sheet - this spreadsheet will contain the output once generated. It will have two sheets, "Output1" and "Output2".

The file data.py contains links to these three files in the form of file IDs. File IDs are a part of the URL of the spreadsheet.
